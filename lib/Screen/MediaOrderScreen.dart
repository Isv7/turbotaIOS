...
class MediaOrderScreen extends StatefulWidget {
  final burial;
  final List<Service> services;

  MediaOrderScreen(this.burial, this.services);
  @override
  _MediaOrderScreenState createState() => _MediaOrderScreenState();
}

class _MediaOrderScreenState extends State<MediaOrderScreen> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
      appBar: AppBar(
        title: Text(S.of(context).OrderMedia),
        centerTitle: true,
      ),
      body: Stack(
        fit: StackFit.expand,
